...
<script language="JavaScript">
  ...
  <div id="content">
    <p><font size="5" color="#000000">Pesquisar Produtos</font></p>
    ...
    <div id="scroll2">
      <table width="648" cellspacing="3" bordercolordark="#000000" bgcolor="#0066FF">
    <tr></tr>
    <tr></tr>
    <tr></tr>
    <tr>
      <th width="318" bgcolor="#33FF33" scope="col">IMAGEM</th>
      <th width="320" bgcolor="#33FF33" scope="col">INFORMAÇÕES</th>
    </tr>
    <?php
		  include("conexao.php");
if($_GET['funcao'] == "pesquisar"){	
	...
	while($linha = mysql_fetch_array($sql_resp)){
		...
		?>
    <tr>
      <td rowspan="6"><img src="fotos/<?php echo $foto ?>" width="320" height="176" align="texttop" /></td>
      <td>ID: <?php echo $n?></td>
    </tr>
    <tr>
	...
	while($linha1 = mysql_fetch_array($sql_resp1)){
		...
		?>
    <tr>
      <td rowspan="6"><img src="fotos/<?php echo $foto ?>" width="321" height="175" align="middle" /></td>
      <td>ID: <?php echo $n?></td>
    </tr>
    <tr>
      <td>PRODUTO: <?php echo $produto?></td>
