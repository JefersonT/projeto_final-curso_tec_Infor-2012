...
<script language="JavaScript">
	...
	<div id="header">
		<div id="logo">
			<ha><a href="promocoes.php">Promoções</a></ha>
		</div>
		<div id="slogan">
...
if($_GET['funcao'] == "pesquisar"){	
	...
	while($linha = mysql_fetch_array($sql_resp)){
		...
		?>
        <tr>
          <td rowspan="8"><center><img src="fotos/<?php echo $foto ?>" width="283" height="134" align="texttop" /></center></td>
	...
	while($linha1 = mysql_fetch_array($sql_resp1)){
		...
		?>
        <tr>
          <td rowspan="8"><center><img src="fotos/<?php echo $foto ?>" width="303" height="139" align="texttop" /></center></td>
          <td>PRODUTO: <?php echo $produto?></td>
        </tr>
        <tr>
          <td>MARCA: <?php echo $marca?></td>
