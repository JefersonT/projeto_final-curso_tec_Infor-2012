...
<script language="JavaScript">
	...
	<div id="header">
		<div id="logo">
			<h3><a href="anuncios.php">Configurações de Anúncios</a></h3>
		</div>
		<div id="slogan">
  ...
  <div id="content">
	...
	while($linha = mysql_fetch_array($sql_resp)){
	    ...
	    <tr>
	      <td><center><img src="fotos/<?php echo $foto ?>" width="555" height="456"  /></center></td>
        </tr>
	    <tr>
...
<table width="665" cellspacing="3" bgcolor="#CCCCCC">
        ...
        <tr>
          <td><img src="fotos/<?php echo $fotos ?>" width="278" height="140" align="texttop" /></td>
        </tr>
