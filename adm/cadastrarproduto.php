...
if($_GET['funcao'] == "pesquisar"){	
	...
	while($linha = mysql_fetch_array($sql_resp)){
		...
		?>
        <tr>
          <td rowspan="8"><img src="fotos/<?php echo $foto ?>" width="320" height="176" align="texttop" /></td>
          <td>ID: <?php echo $n?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>PREÇO: R$ <?php echo $preco?></td>
        </tr>
        <tr>
          <td>PESO OU VOLUME: <?php echo $peso?></td>
        </tr>
        <tr bgcolor="#FFFF66">
          <td><center><a href="cadastrarproduto.php?funcao=alterarinfor&id=<?php echo $n ?>">Editar Informações</a></center></td>
        </tr>
        <tr>
	...
	while($linha1 = mysql_fetch_array($sql_resp1)){
        ...
        <tr>
          <td bgcolor="#FFFF66"><center><a href="cadastrarproduto.php?funcao=alterarinfor&id=<?php echo $n ?>">Editar Informações</a></center></td>
        </tr>
        <tr>
          <td bgcolor="#FFFF66">
          <center>
...
<table width="665" bgcolor="#CCCCCC" cellspacing="3">
        ...
        <tr>
          ...
          IMAGEM:
            <p><img src="fotos/<?php echo $foto ?>" width="290" height="176" align="texttop" /></p></th>
          <td width="383"><p>
...
<table width="665" cellspacing="3" bgcolor="#CCCCCC">
        ...
        <tr>
          <th rowspan="5" scope="row"><img src="fotos/<?php echo $fotos ?>" width="278" height="140" align="texttop" /></th>
