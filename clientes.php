...
<script language="JavaScript">
	...
	<div id="header">
		<div id="logo">
			<h1><a href="inicio.php">Clientes</a></h1>
		</div>
		<div id="slogan">
  ...
  <div id="content">
	  <div class="box">
		<h2>Clientes</h2>
				<p>Nesta página você reseberá as informações necessaria para estar por dentro do que esta acontecendo no Mercadinho H&amp;C, como funciona o sistema de entrega dos produtos e outros.</p>
		<p>Alem de tirar suas dúvidas fazendo perguntas nas quais você tem curiosidade.</p>
	  </div>
