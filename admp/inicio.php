	  ...
	  <form id="form1" method="post" action="funcao.php?funcao=gravar">
	    <table width="290" border="0" cellspacing="3">
	      ...
	      <tr align="center" bgcolor="#33FF99">
          	<td width="153" bgcolor="#66FF00"><strong>Nome</strong></td>
	        <td width="167" bgcolor="#66FF00"><strong>E-Mail</strong></td>
	        <td width="329" bgcolor="#66FF00"><strong>Comentario</strong></td>
	        </tr>
	      <?php
  include("conexao.php");
