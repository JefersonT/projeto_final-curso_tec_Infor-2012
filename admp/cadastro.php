...
<script language="JavaScript">
	...
	<div id="header">
		<div id="logo">
		  <ha><a href="cadastro.php">Cadastros</a></ha>
		</div>
		 <div id="slogan">
  ...
  <div id="content">
	  <div class="box">
		<h2>Cadastre-se</h2>
		<p>Nesta página você pode realizar seu cadastro para que possa fazer seus pedidos diretamente de nosso Site dessa forma aumentando a facilidade de fazer suas encomendas mais vapidas.</p>
		<p>&nbsp;</p>
	  </div>
	  <p>Cadastre-se:</p>
	  <form id="form1" method="post" action="funcao.php?funcao=cadastrar">
	    <table width="543" cellspacing="3">
	      <tr>
	        <th scope="row">Nome Completo:</th>
	        <td><label for="nome2"></label>
	          <input name="nome2" type="text" id="nome2" size="60" /></td>
          </tr>
	      <tr>
	      ...
	      <tr>
	        ...
	        <td><label for="telefone"></label>
	          <input type="text" name="telefone" id="telefone" /></td>
          </tr>
	      <tr>
	        <th scope="row">CPF:</th>
	        <td><label for="cpf"></label>
	          <input name="cpf" type="text" id="cpf" value="000.000.000-00" size="30" /></td>
          </tr>
	      <tr>
